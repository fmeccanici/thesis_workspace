...
class GeomagicTouch
{
    public:
        ...
        ros::Subscriber geo_effort_sub, geo_enable_haptic_sub, refine_force_sub, keyboard_sub;

        GeomagicTouchState *geo_state;

        bool grey_button, white_button;
        int en_h_count;
        ...
        void refine_callback(const geometry_msgs::WrenchStamped refine_force);
        void keyboard_callback(const geomagic_touch_m::GeomagicButtonEvent buttons);
};
